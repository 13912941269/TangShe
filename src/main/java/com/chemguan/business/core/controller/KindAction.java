...
public class KindAction {
    ...
    public void uploadFile(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // 文件保存目录路径
        String savePath = imgRoot + "upload/image" + File.separatorChar
                + File.separatorChar;

        String pathsw = request.getContextPath();
        String basePathsw = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+pathsw+"/";
        String saveUrl = basePathsw+"projectimg/upload/image" + File.separatorChar
                + File.separatorChar;
        ...
        for (Iterator<Map.Entry<String, MultipartFile>> it = fileMap.entrySet().iterator(); it.hasNext();) {
            ...
            // 检查文件大小
            if ((mFile.getSize()/1024/1024) > maxSize) {
    ...
    public void fileManager(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // 文件保存目录路径
        String rootPath = imgRoot + "upload/image" + File.separatorChar;
        String pathsw = request.getContextPath();
        String basePathsw = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+pathsw+"/";
        String rootUrl = basePathsw+"projectimg/upload/image" + File.separatorChar;
