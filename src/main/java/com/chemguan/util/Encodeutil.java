...
public class Encodeutil {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	//System.out.println(getMD5("zg"));
    	
    	//建立连接
    	/*URL url=new URL("https://www.cnblogs.com/jun9207/p/5191857.html");
    	//打开连接
    	URLConnection openConnection = url.openConnection();
    	//输入流
    	InputStreamReader isr=new InputStreamReader(openConnection.getInputStream());
    	//缓冲区
    	...
    	StringBuffer sb=new StringBuffer();
         ...
         Element elementById = parse.getElementById("stats_article_count");
