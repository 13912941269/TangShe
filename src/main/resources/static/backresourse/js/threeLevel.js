 /**
            ...
            pro.change(function(){
                ...
                if(num1!==0){
                    for(var i=0;i<province[num1-1].city.length;i++){
                        var $temp=$("<option>"+province[num1-1].city[i].name+"</option>");
                        city.append($temp);
                    }
                }
            });
            city.change(function(){
                ...
                if(num2!==0){
                    for(var i=0;i<province[num1-1].city[num2-1].districtAndCounty.length;i++){
                        var $temp=$("<option>"+province[num1-1].city[num2-1].districtAndCounty[i]+"</option>");
                        dAC.append($temp);
                    }
                }
            })
        ...
        function init(){
            ...
            for(var i=0;i<province.length;i++){
                var $temp=$("<option>"+province[i].name+"</option>");
                pro.append($temp);
            }
        }